...
public class Robot extends LoggedRobot {
  ...
  NoteVisionIOReal noteVision = new NoteVisionIOReal();
static Drive drive;
  ...
  public void robotPeriodic() {
	...
	SmartDashboard.putNumber("note X", noteVision.getNotePose(pose).getX());
	SmartDashboard.putNumber("note Y", noteVision.getNotePose(pose).getY());
