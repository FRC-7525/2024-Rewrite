...
public class Manager extends Subsystem<ManagerStates> {
  ...
  public Manager() {
    ...
    addTrigger(
        ManagerStates.IDLE, ManagerStates.SCORE_AMP, () -> controller.getLeftBumperPressed());
    addTrigger(
        ManagerStates.SCORE_AMP, ManagerStates.SCORE_AMP, () -> controller.getLeftBumperPressed());

    addTrigger(
        ManagerStates.IDLE, ManagerStates.SPINNING_UP, () -> controller.getRightBumperPressed());
    addTrigger(
        ManagerStates.SPINNING_UP, ManagerStates.IDLE, () -> controller.getRightBumperPressed());

    addTrigger(
        ManagerStates.SPINNING_UP, ManagerStates.SHOOTING, () -> controller.getBButtonPressed());
