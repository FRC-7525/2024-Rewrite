...
public class IntakeIOSim implements IntakeIO {
  ...
  public IntakeIOSim() {
    ...
    spinnerWheelSim =
        new DCMotorSim(DCMotor.getFalcon500(1), Constants.Intake.GEARING, 0.192383865);
  ...
  public void setSetpoints(
    ...
    pivotAppliedVoltage =
        pivotController.calculate(pivotSimModel.getVelocityRadPerSec() * 60, pivotMotorSetPoint);
  ...
  public double getPosition() {
    System.out.print(pivotAppliedVoltage);
