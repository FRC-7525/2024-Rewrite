...
public class ShooterIOTalonFX implements ShooterIO {
	...
	public void setSpeed(double rps) {
		speedPoint = rps;
		leftAppliedVolts = feedbackController.calculate(leftMotor.getRotorVelocity().getValueAsDouble(), rps);
		rightAppliedVolts = feedbackController.calculate(rightMotor.getRotorVelocity().getValueAsDouble(), rps);
