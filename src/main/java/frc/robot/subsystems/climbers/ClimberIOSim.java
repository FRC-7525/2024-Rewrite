...
public class ClimberIOSim implements ClimberIO {
    ...
    public void setSetpoints(double leftSetpoint, double rightSetpoint) {
        ...
        appliedVolts = controller.calculate(climberSim.getAngularPositionRotations(), climberSetpoint);
    ...
    public boolean nearSetpoints() {
        return Math.abs(climberSim.getAngularPositionRotations() - climberSetpoint) < Constants.Climber.ERROR_OF_MARGIN;
    }
